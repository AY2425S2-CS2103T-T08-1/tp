...
with(this){return _c('h3',{attrs:{"id":"proposed-storing-a-customer-s-dietary-preference-feature"}},[_v("[Proposed] Storing a customer's dietary preference feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-storing-a-customer-s-dietary-preference-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2: The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("savePreference 1 /sChicken rice")]),_v(", causing a preference to be added to the customer.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"proposed-finding-customers-by-dietary-preferences-feature"}},[_v("[Proposed] Finding customers by dietary preferences feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-finding-customers-by-dietary-preferences-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The same centry exists (i.e same name and number)")]),_v(" "),_c('ul',[_c('li',[_v("1a1. Bitebook shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Tags")]),_v(": A marker flavpur text for each customer (E.g VIP)")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 23:37:05 GMT+8]")])])])}
}];
