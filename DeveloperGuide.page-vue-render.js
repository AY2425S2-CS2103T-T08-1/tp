...
with(this){return _c('h3',{attrs:{"id":"storing-a-customer-s-dietary-preference-feature"}},[_v("Storing a customer's dietary preference feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#storing-a-customer-s-dietary-preference-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2: The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("savePreference 1 s/Chicken rice")]),_v(", causing a preference to be added to the customer.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-customers-by-dietary-preferences-feature"}},[_v("Finding customers by dietary preferences feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-customers-by-dietary-preferences-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2: The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findPreferences no seafood")]),_v(", causing customers who have that preference to be shown.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Restaurant owners who want to keep track of their clientele and regular customers")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Improve the quality of service for customers by enabling regulars to contact easily their favourite restaurant")]),_v(" "),_c('li',[_v("Increase interpersonal relationships with customers by keeping track of their preferences")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("add new customers to the address book")]),_v(" "),_c('td',[_v("keep track of their contact details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("delete customer records")]),_v(" "),_c('td',[_v("remove outdated or incorrect information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("tag customers with labels (e.g., VIP, Regular, New)")]),_v(" "),_c('td',[_v("personalize their experience")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("store customer preferences and allergies")]),_v(" "),_c('td',[_v("provide a personalized dining experience.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("customer feedback and complaints (To add in the future)")]),_v(" "),_c('td',[_v("improve my restaurant’s service")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("see a customer’s past orders (To add in the future)")]),_v(" "),_c('td',[_v("recommend seasonal dishes they might enjoy")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("group customers by dining preferences (e.g., vegetarian, wine lovers, family diners)")]),_v(" "),_c('td',[_v("offer them relevant recommendations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Restaurant owner")]),_v(" "),_c('td',[_v("track customer satisfaction scores based on their feedback (To add in the future)")]),_v(" "),_c('td',[_v("improve my service.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("BiteBook")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Restaurant owner")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add new customers to the address book")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The same entry exists (i.e same name and number)")]),_v(" "),_c('ul',[_c('li',[_v("1a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete customers in the address book")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. Bitebook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Tag customers with labels (e.g., VIP, Regular, New)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2b. The tag is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. Bitebook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add orders for customer")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User list all customers")])]),_v(" "),_c('li',[_c('p',[_v("User enters into the command line (addOrder 1 d/Fish soup)")])]),_v(" "),_c('li',[_c('p',[_v("fish soup appears in the top 3 dishes")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2b. The dish already exists in the customer's past orders")]),_v(" "),_c('ul',[_c('li',[_v("2b1. If the top 3 dishes have a higher count than fish soup, then fish soup does not appear")])]),_v(" "),_c('p',[_v("Use case ends.")]),_v(" "),_c('ul',[_c('li',[_v("2b2. fish soup")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("3a. No prefix (/d) is added")]),_v(" "),_c('ul',[_c('li',[_v("3a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Find all customers with a certain preference")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User enters a valid findPreferences command (findPreferences No seafood)")]),_v(" "),_c('li',[_v("Lists all customers matching the preference")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. No customers have the given preference")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Shows \"0 persons listed!\"")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. No preferences provided")]),_v(" "),_c('ul',[_c('li',[_v("3a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Find all customers with a certain order")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User enters a valid findOrders command (findOrders d/Fish soup)")]),_v(" "),_c('li',[_v("Lists all customers with the order")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. No customers have the given dish")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Shows \"0 persons listed!\"")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. NNo prefix (/d) is added")]),_v(" "),_c('ul',[_c('li',[_v("3a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Save preference for a customer")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User enters a valid savePreference command (savePreference 1 s/no salt)")]),_v(" "),_c('li',[_v("The first contact information preference is saved as no salt")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. No prefix (/s) is added")]),_v(" "),_c('ul',[_c('li',[_v("3a1. Bitebook shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. There is an existing preference saved for the customer")]),_v(" "),_c('ul',[_c('li',[_v("4a1. The existing preference becomes the new preference")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Clear all contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User enters a valid clear command (clear)")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User enters a valid exit command (exit)")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Tags")]),_v(": A marker flavour text for each customer (E.g VIP)")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"1-add-a-new-customer"}},[_v("1. Add a New Customer"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-add-a-new-customer","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Add a customer named Alice with preferences and a tag:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Alice Tan p/91234567 t/Regular s/no seafood")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"2-tag-a-customer"}},[_v("2. Tag a Customer"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-tag-a-customer","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Tag the customer with:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tag 1 t/NEW")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Overwriting existing tag")]),_v(" "),_c('li',[_v("Clearing tag with:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tag 1 t/")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"3-save-preferences"}},[_v("3. Save Preferences"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#3-save-preferences","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Add dietary preferences:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("savePreference 1 s/no dairy")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("savePreference 1 s/no seafood")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Duplicate prevention:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("savePreference 1 s/no dairy")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"4-add-past-orders"}},[_v("4. Add Past Orders"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#4-add-past-orders","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Add multiple dishes (with variations in spacing and case):"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addOrder 1 d/Chicken Rice")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addOrder 1 d/iced milo")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addOrder 1 d/Iced Milo")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addOrder 1 d/Nasi Lemak")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addOrder 1 d/Nasi Lemak")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Frequency sorting in UI top 3")]),_v(" "),_c('li',[_v("Normalization (case & spacing)")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"5-view-past-orders"}},[_v("5. View Past Orders"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#5-view-past-orders","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("View the customer’s order history:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("viewOrders 1")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Orders are displayed")]),_v(" "),_c('li',[_v("Most frequent ones appear in top 3 dishes")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"6-find-by-preferences"}},[_v("6. Find by Preferences"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#6-find-by-preferences","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Search by dietary preferences:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findPreferences no seafood")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findPreferences no dairy")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"7-find-by-order-history"}},[_v("7. Find by Order History"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#7-find-by-order-history","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Search by past orders:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findOrders nasi lemak")]),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findOrders iced milo")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"8-find-by-name-tag"}},[_v("8. Find by Name / Tag"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#8-find-by-name-tag","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Search by name:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find alice")]),_c('br'),_v("\nSearch by tag:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findTag VIP")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"9-delete-customer"}},[_v("9. Delete Customer"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#9-delete-customer","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Delete the customer from the list:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Person is removed")]),_v(" "),_c('li',[_v("Indexes shift appropriately")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"10-clear-all-entries"}},[_v("10. Clear All Entries"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#10-clear-all-entries","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Reset the app to empty state:"),_c('br'),_v(" "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("No customers remain")]),_v(" "),_c('li',[_v("App behaves normally post-clear")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Make add command handle multiple preferences")]),_v(": The current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command only supports a single preference, but a customer can have multiple preferences. We plan to modify the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command to accept multiple preference inputs, allowing users to specify more than one preference when adding a contact.")]),_v(" "),_c('li',[_c('strong',[_v("Allow the use of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("'")]),_v(" in names")]),_v(": The current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command only allows alphanumeric characters in the name field. We plan to improve this by allowing characters such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("'")]),_v(", so names like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("s/o John")]),_v(" can be properly added to BiteBook.")]),_v(" "),_c('li',[_c('strong',[_v("Normalize spacing in names")]),_v(": When adding a customer details, any internal spaces in the names are not handled, so it allows "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John   Doe")]),_v(" with the same phone number can be added into BiteBook. To solve this, we plan to collapse the multiple spaces between words into a single space. For example, both "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John   Doe")]),_v(" will be stored as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" to ensure consistent formatting.")]),_v(" "),_c('li',[_c('strong',[_v("Allow phone numbers with 3 to 17 digits")]),_v(": Currently, our app requires phone numbers to have at least 8 digits. However, in real-world scenarios, phone number lengths can vary between 3 and 17 digits. Therefore, we plan to relax the current constraint to accommodate this range.")]),_v(" "),_c('li',[_c('strong',[_v("Menu Integration for Order Consistency")]),_v(": To reduce variability in order entries (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("milo")]),_v(" vs "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("iced milo")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ice milo")]),_v("), a fixed menu system will be implemented. This menu will contain standardized food and drink items that customers can select from when placing an order. The saveOrder function will be updated to only allow selections from this predefined menu, improving data consistency and enabling better analytics.")]),_v(" "),_c('li',[_c('strong',[_v("Editable Tag System for Customer Categorization")]),_v(": Currently, customer tags may be too rigid or inconsistent. To offer more flexibility, restaurant owners will be able to edit and manage the fixed list of available tags (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VIP")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Vegetarian")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Allergy-prone")]),_v("). This ensures the tags remain relevant to the restaurant’s evolving customer base and operational needs, while still enforcing consistency in their application.")]),_v(" "),_c('li',[_c('strong',[_v("Support Deletion of Individual Orders")]),_v(": Currently, our system does not support deleting individual orders. If we need to delete an order for a customer, we are required to delete the entire customer record and re-enter the customer's details. We plan to implement a feature that allows for the deletion of individual orders without affecting the entire customer profile.")]),_v(" "),_c('li',[_c('strong',[_v("Support Deletion of Customer Preferences")]),_v(": Similar to the \"Delete Order\" functionality, we do not currently have an option to delete individual preferences. To remove preferences, we must delete and re-enter the entire customer record. We aim to introduce a more granular approach to allow for the deletion of preferences independently.")]),_v(" "),_c('li',[_c('strong',[_v("Expand Categories of Customer Tags")]),_v(": Currently, the tags available in our system are limited to customer status, such as \"VIP,\" \"Regular,\" and \"New.\" We plan to expand the tagging system to include a broader variety of tags, such as those related to customer preferences, enabling better categorization and segmentation.")]),_v(" "),_c('li',[_c('strong',[_v("Improve Efficiency of Filtered List Operations")]),_v(": When performing filter operations like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findOrders")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findPreferences")]),_v(", the system currently returns the full list of results after a tag command is applied, instead of staying within the filtered list. This behavior reduces the efficiency of filtering and can lead to unnecessary data being returned. We plan to fix this so that filtered lists remain intact after applying tags.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 0:06:13 GMT+8]")])])])}
}];
